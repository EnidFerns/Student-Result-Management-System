    ...
    public partial class FormStudentLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(textBox1.Text) && !string.IsNullOrEmpty(textBox2.Text))
            {
                try
                {
                    OleDbConnection con = new OleDbConnection("Provider = Microsoft.JET.OLEDB.14.0; Data Source = 'E:\\StudentResultManagementSystem.xlsx'; Extended Properties = Excel 8.0;");
                    con.Open();
        ...
        private void FormStudentLogin_Load(object sender, EventArgs e)
        {
